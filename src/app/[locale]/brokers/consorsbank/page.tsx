    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          {selectedTab === 'overview' && (
            <div className="space-y-12">
              ...
              {/* Why Consorsbank */}
              <div className="card bg-gradient-to-br from-teal-50 to-white border-2 border-teal-200">
              ...
              {/* CTA */}
              <div className="card bg-gradient-to-br from-teal-600 to-teal-700 text-white text-center">
                ...
                <a
                  ...
                  className="inline-flex items-center gap-2 px-10 py-5 bg-white text-teal-700 rounded-xl font-bold text-lg hover:bg-gray-100 transition-all shadow-2xl transform hover:-translate-y-1"
                >
                  <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="space-y-8">
              <div className="card">
                ...
                <div className="space-y-6">
                  <div className="bg-gradient-to-br from-teal-50 to-white border-2 border-teal-200 rounded-xl p-6">
                    ...
                    <div className="space-y-4">
                      <div className="bg-white rounded-lg p-4">
                        <div className="text-3xl font-bold text-teal-600 mb-2">4,95€ + 0,25%</div>
                  ...
                  <div className="bg-gradient-to-r from-teal-50 to-teal-100 border-l-4 border-teal-500 rounded-lg p-6">
            ...
            <div className="space-y-8">
              <div className="card">
                ...
                <div className="bg-gradient-to-br from-gray-900 to-gray-800 text-white rounded-2xl p-8">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                      <h4 className="font-bold mb-3 text-teal-300">{locale === 'de' ? 'Persönlicher Support' : 'Personal Support'}</h4>
                    ...
                    <div>
                      <h4 className="font-bold mb-3 text-teal-300">{locale === 'de' ? 'Bildungsangebote' : 'Educational Offerings'}</h4>
                      <ul className="space-y-2 text-gray-300">
              ...
              <div className="card">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                  <div className="text-center">
                    <div className="text-7xl font-bold text-teal-600 mb-2">{stats.averageRating}</div>
                  ...
                  {reviews.map((review, index) => (
                    <div key={index} className="card hover:shadow-lg transition-shadow">
                      <div className="flex items-start justify-between mb-4">
                        <div className="flex items-center gap-3">
                          <div className="w-12 h-12 bg-gradient-to-br from-teal-500 to-teal-600 text-white rounded-full flex items-center justify-center font-bold text-lg">
                      ...
                      <div className="flex items-center justify-between pt-4 border-t border-gray-200">
                        <button className="text-gray-600 hover:text-teal-600 transition-colors flex items-center gap-2">
                          <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <div className="bg-gradient-to-r from-teal-600 to-teal-700 py-16">
        <div className="container-custom text-center text-white">
          ...
          <p className="text-teal-200 text-sm mt-4 flex items-center justify-center gap-2">
